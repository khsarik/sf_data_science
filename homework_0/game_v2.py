...
def random_predict(number: int = 1) -> int:
    ...
    Changes in code:
        - Получение предпологаемого числа было переписано таким образом, что при каэдой
        итерации среднее суммы числа еачала и конца диапозона. Таким образом, у нас станет
        значительно ментше попыток угадывания с 1-3 раз, но станет меньше среднее количество
        попыток угадывания числа для всей выборки.
